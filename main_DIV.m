...
% y0 = Y_output(:,end);
y0(69:72)=0;%all S ia assumed to be 0 after Z-ring closed
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
+ p.depol_podJ*y(2+4)...%
    +4*p.D_podJm*(y(1)-y(2))/((y(73)+y(74))^2)- p.mu*y(2);
% Bin 3
...
+ p.depol_podJ*y(3+4)...%
        +4*p.D_podJm*(y(4)-y(3))/((y(73)+y(74))^2)- p.mu*y(3);
% Bin 4
...
dydt(6) =-(p.deg_podJ1+p.deg_podJp*y(6+60))*y(6)...%PerP:65-68
    ...
    - p.depol_podJ*y(6)...%
    + 4*p.D_podJL*(y(5)-y(6))/((y(73)+y(74))^2) - p.mu*y(6); 
%Bin 7
dydt(7) =-(p.deg_podJ1+p.deg_podJp*y(7+60))*y(7)...%PerP:65-68
    ...
    - p.depol_podJ*y(7)...%
        + 4*p.D_podJL*(y(8)-y(7))/((y(73)+y(74))^2) - p.mu*y(7); 
% Bin 8
...
dydt(14) = p.syn_spmx*y(14+20)^q/(y(14+20)^q+p.Ja_SpmXCtrA^q)-(p.deg_spmx+p.mu)*y(14)...%CtrAP 33-36 
  ...
  -p.aut_spmx*(1+p.alpha_SpmXPopZ*(y(14+8)+y(14+12)))*y(14)*y(14+4)^2 ...%PopZp 25-28
    +4*p.D_spmx*(y(13)-y(14))/((y(73)+y(74))^2);
%Bin 15
dydt(15) = p.syn_spmx*y(15+20)^q/(y(15+20)^q+p.Ja_SpmXCtrA^q)-(p.deg_spmx+p.mu)*y(15)...%CtrAP 33-36 
  ...
  -p.aut_spmx*(1+p.alpha_SpmXPopZ*(y(15+8)+y(15+12)))*y(15)*y(15+4)^2 ...%PopZp 25-28
    +4*p.D_spmx*(y(16)-y(15))/((y(73)+y(74))^2);
%Bin 16
...
dydt(18)=-(p.deg_spmx+p.mu)*y(18)...
    +p.dnv_spmx*y(18-4)-p.depol_spmx*y(18)...
      ...
      +4*p.D_spmxp*(y(17)-y(18))/((y(73)+y(74))^2);
%Bin 19
dydt(19)=-(p.deg_spmx+p.mu)*y(19)...
    +p.dnv_spmx*y(19-4)-p.depol_spmx*y(19)...
      +p.aut_spmx*(1+p.alpha_SpmXPopZ*(y(19+4)+y(19+8)))*y(19-4)*y(19)^2 ...%PopZp 25-28
        +4*p.D_spmxp*(y(20)-y(19))/((y(73)+y(74))^2);
%Bin 20
...
dydt(22) =p.syn_popz  - (p.mu+p.deg_popzm)*y(22)...
    -p.dnv_popz*y(22)-p.aut_popz*(1+p.alpha_PopZPodJ*(y(22-20)+y(22-16)))*y(22+4)^2*y(22)...%PodJp 5-8
    +p.depol_popz*y(22+4)...
+4*p.D_popzm*(y(21)-y(22))/((y(73)+y(74))^2);
%Bin 23
dydt(23) = p.syn_popz -( p.mu+p.deg_popzm)*y(23)...
  -p.dnv_popz*y(23)-p.aut_popz*(1+p.alpha_PopZPodJ*(y(23-20)+y(23-16)))*y(23+4)^2*y(23)...%PodJp 5-8
    +p.depol_popz*y(23+4)...
+4*p.D_popzm*(y(24)-y(23))/((y(73)+y(74))^2);
% Bin 24
...
dydt(26) = -(p.mu+p.deg_popzp)*y(26)...
    +p.dnv_popz*y(26-4)+p.aut_popz*(1+p.alpha_PopZPodJ*(y(26-24)+y(26-20)))*y(26)^2*y(26-4)...%PodJp 5-8
    -p.depol_popz*y(26)...
   +4*p.D_popzp*(y(25)-y(26))/((y(73)+y(74))^2);
%Bin 27
dydt(27) = -(p.mu+p.deg_popzp)*y(27)...
    +p.dnv_popz*y(27-4)+p.aut_popz*(1+p.alpha_PopZPodJ*(y(27-24)+y(27-20)))*y(27)^2*y(27-4)...%PodJp 5-8
    -p.depol_popz*y(27)...
  +4*p.D_popzp*(y(28)-y(27))/((y(73)+y(74))^2);
%Bin 28
...
+4*p.D_CtrA*(y(29)-y(30))/((y(73)+y(74))^2);
%Bin 31
...
+4*p.D_CtrA*(y(32)-y(31))/((y(73)+y(74))^2);
%Bin 32
...
%Bin 34
 dydt(34)=-(p.mu+p.deg_ctrA1+p.deg_ctrA2*(y(34+24)+y(34+28))^2/(p.Jd_CtrA^2+(y(34+24)+y(34+28))^2))*y(34) ...%DivKP 57-60
    ...
    + 4*p.D_CtrAP*(y(33)-y(34))/((y(73)+y(74))^2);
%Bin 35
 dydt(35)=-(p.mu+p.deg_ctrA1+p.deg_ctrA2*(y(35+24)+y(35+28))^2/(p.Jd_CtrA^2+(y(35+24)+y(35+28))^2))*y(35) ...%DivKP 57-60
    ...
    + 4*p.D_CtrAP*(y(36)-y(35))/((y(73)+y(74))^2);
%Bin 36
...
dydt(38)=p.syn_pleC*m_pleC -(p.mu+p.deg_pleC)*y(38) ...
    ...
    + 4*p.D_PleC*(y(37)-y(38))/((y(73)+y(74))^2);
%Bin 39
dydt(39)=p.syn_pleC*m_pleC -(p.mu+p.deg_pleC)*y(39) ...
    ...
    + 4*p.D_PleC*(y(40)-y(39))/((y(73)+y(74))^2);
%Bin 40
...
+4*p.D_DivK*(y(53)-y(54))/((y(73)+y(74))^2);
%Bin 55
...
+4*p.D_DivK*(y(56)-y(55))/((y(73)+y(74))^2);
%Bin 56
...
-p.fb_DivKP*y(58)+p.bf_DivKP*y(58+4)+4*p.D_DivKP*(y(57)-y(58))/((y(73)+y(74))^2);
%Bin 59
...
-p.fb_DivKP*y(59)+p.bf_DivKP*y(59+4)+4*p.D_DivKP*(y(60)-y(59))/((y(73)+y(74))^2);
%Bin 60
