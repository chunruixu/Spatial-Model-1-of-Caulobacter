...
PopZp = yout(25:28,:);
PopZp = flipud(PopZp);
PopZ = yout(21:24,:)+yout(25:28,:);
PopZ = flipud(PopZ);
SpmX=yout(13:16,:)+yout(17:20,:);
SpmX = flipud(SpmX);

DivJb=yout(49:52,:);
DivJ=yout(45:48,:)+DivJb;
DivJ = flipud(DivJ);
DivJb = flipud(DivJb);
PleC=yout(37:40,:)+yout(41:44,:);
PleC = flipud(PleC);
DivK=yout(53:56,:);
DivK = flipud(DivK);
DivKP=yout(57:60,:)+yout(61:64,:);
DivKP = flipud(DivKP);
CtrAP=yout(33:36,:);
CtrAP = flipud(CtrAP);
CtrA=yout(29:32,:);
...
SpmX=(yout(13,:)+yout(16,:)+yout(17,:)+yout(20,:)).*yout(73,:)+(yout(14,:)+yout(15,:)+yout(18,:)+yout(19,:)).*yout(74,:);
...
%   DivJf=yout(45:48,:); DivJb=yout(49:52,:);
% DivJT=DivJf+DivJb;
...
subplot(3,2,4) 
% subplot(4,1,3)%PleC
%   PleCf=yout(37:40,:); PleCb=yout(41:44,:);
...
subplot(3,2,5) 
%    subplot(4,1,4)%DivK
%   DivK=yout(53:56,:); DivKP=yout(57:60,:)+yout(61:64,:);
...
% CtrAP = yout(33:36,:);
CtrAP =(yout(33,:)+yout(36,:)).*yout(73,:)+(yout(34,:)+yout(35,:)).*yout(74,:);
CtrAT=(yout(29,:)+yout(32,:)).*yout(73,:)+(yout(30,:)+yout(31,:)).*yout(74,:)+CtrAP;
